...
models_to_apply = [
    ("UVR-DeNoise.pth", 1),  # Use the second file (index 1) from the DeNoise model
    ("UVR-DeEcho-DeReverb.pth", 0),  # Use the first file (index 0) from the DeReverb/DeEcho model
]

# Process the audio file with a user-friendly final output name
final_output = process_audio(input_audio, models_to_apply, final_output_name="cleaned_audio.wav")
